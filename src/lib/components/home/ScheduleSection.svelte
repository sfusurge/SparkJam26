...
<section class="relative mt-24 mx-auto w-full max-w-[1334px] px-[3%] max-sm:-ml-19 max-sm:w-[155%]" aria-labelledby="s03-title">
	<SectionBadge label="03" class="-rotate-[15deg] max-sm:scale-70 max-sm:-top-8 max-sm:ml-5" />
	<div class="max-sm:grid-cols-1 relative mt-14 grid gap-0  bg-boba-black grid-cols-[minmax(0,522px)_1fr]">
		...
		<div class="space-y-8 border rounded-xl border-boba-black bg-canvas-grey border-t border-l-0 p-10 max-sm:text-[22px]">
