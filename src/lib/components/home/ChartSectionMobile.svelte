...
<section
		class="relative mt-24 w-full max-sm:w-screen"
		aria-labelledby="chart-section-heading"
>
	<div class="mx-auto w-full max-w-[1334px] px-[3%] max-sm:px-0 max-sm:-ml-15">
		<SectionBadge label="05" class="-rotate-[12deg] max-sm:scale-70 max-sm:-top-8 max-sm:-ml-16" />
		...
		<div class="relative mt-14">
			...
			<div class="overflow-hidden border-2 border-boba-black bg-boba-black">
				...
				>
						<div class="flex h-full min-h-[600px] items-end gap-32 overflow-x-auto px-32 pb-10 pt-10 scroll-smooth snap-x snap-mandatory">						{#each bars as bar, i}
							{@const isActive = visibleIndex === i}

							<button
									type="button"
									class="snap-center group relative flex w-[192px] shrink-0 cursor-pointer flex-col items-center justify-end focus:outline-none"
