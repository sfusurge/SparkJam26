...
>
	...
	<div class="relative mt-14">
		...
		>
			...
			<!-- Chart -->
			<div class="backgroundImg relative min-h-[600px] bg-no-repeat">
				<!-- <img  class="backgroundImg" src="/background/background.svg" alt="" /> -->
						...
						>
							...
							>
								...
								<img
									...
									alt=""
									aria-hidden="true"
									class="pointer-events-none absolute -top-[5px] left-1/2 h-full w-[192px] translate-x-[calc(-50%_+_var(--bar-shift))] select-none object-fill transition-opacity duration-200 {selected ===
									i
										? 'opacity-100'
										: 'opacity-0'}"
									draggable="false"
